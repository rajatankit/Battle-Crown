...
// Returns combined inbox: this user's PERSONAL notifications + all GLOBAL ones,
// newest first, with a computed `isRead` flag per item.
...
export async function PATCH(request) {
  try {
    ...
    if (notification.type === "PERSONAL") {
      // Make sure users can't mark other people's personal notifications as read
